...
- The "Default" sounds no longer exists. This allows us to provide multiple built in sounds, and simplifies how a highlight figures out which sound to play. If you used this feature, you will need to manually set this sound on individual highlights.
