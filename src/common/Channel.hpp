...
namespace chatterino
{
    ...
    public:
        ...
        // overridingFlags can be filled in with flags that should be used
        // instead of the message's flags. This is useful in case a flag is
        // specific to a type of split
    ...
    public:
        IndirectChannel(
            ChannelPtr channel, Channel::Type type = Channel::Type::Direct);
