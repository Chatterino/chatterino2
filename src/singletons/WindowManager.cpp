    ...
    })
{
    ...
    this->forceLayoutChannelViewsListener.add(settings.hideMessageTimestampsWhenLive);
    ...
    this->layoutChannelViewsListener.add(settings.hideMessageTimestampsWhenLive);
