...
Paths::Paths(const QString &rootAppDataDirectory)
{
    this->initAppFilePathHash();

    this->initCheckPortable();
    this->initRootDirectory(rootAppDataDirectory);
...
void Paths::initRootDirectory(const QString &rootAppDataDirectory)
{
