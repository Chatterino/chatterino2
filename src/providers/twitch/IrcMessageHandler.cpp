...
namespace chatterino
{
    ...
    void IrcMessageHandler::handlePrivMessage(
    ...
    void IrcMessageHandler::addMessage(Communi::IrcMessage* _message,
        const QString& target, const QString& content, TwitchServer& server,
        bool isSub, bool isAction)
    {
        ...
        TwitchMessageBuilder builder(
            chan.get(), _message, args, content, isAction);
    ...
    void IrcMessageHandler::handleClearChatMessage(Communi::IrcMessage* message)
    {
        ...
        if (chan->isEmpty())
        {
            log("[IrcMessageHandler:handleClearChatMessage] Twitch channel {} "
                "not "
                "found",
                chanName);
            return;
    ...
    void IrcMessageHandler::handleNoticeMessage(
