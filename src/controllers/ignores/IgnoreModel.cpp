...
namespace chatterino
{
    ...
    IgnorePhrase IgnoreModel::getItemFromRow(
        std::vector<QStandardItem*>& row, const IgnorePhrase& original)
    {
        // key, regex
    ...
    void IgnoreModel::getRowFromItem(
        const IgnorePhrase& item, std::vector<QStandardItem*>& row)
    {
