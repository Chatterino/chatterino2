...
/// Matches messages that are sent in a channel you have moderator privileges in that matches an AutoMod blocked term.
///
...
struct AutomodCaughtHighlight {
    ...
    friend QDebug operator<<(QDebug dbg, const AutomodCaughtHighlight &v);
};
