#include "widgets/MessagesPopup.hpp"
...
MessagesPopup::MessagesPopup(QWidget *parent)
    : BaseWindow(
          {
              BaseWindow::TopMost,
...
void MessagesPopup::themeChangedEvent()
{
...
void MessagesPopup::refresh()
{
    this->ui_.accountSwitchWidget->refresh();
}

void MessagesPopup::focusOutEvent(QFocusEvent *)
{
    this->hide();
}

void MessagesPopup::paintEvent(QPaintEvent *)
{
