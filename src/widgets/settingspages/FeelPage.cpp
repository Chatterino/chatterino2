...
namespace chatterino
{
        ...
        : SettingsPage("Feel", ":/settings/behave.svg")
    {
        ...
        // layout.append(this->createCheckBox("Use a seperate write
        // connection.",
        //                                    getSettings()->twitchSeperateWriteConnection));
        layout.append(this->createCheckBox(
            SCROLL_SMOOTH, getSettings()->enableSmoothScrolling));
        layout.append(this->createCheckBox(
        ...
        auto form = layout.emplace<QFormLayout>().withoutMargin();
        {
            ...
            form->addRow("Pause chat:", this->createCheckBox(PAUSE_HOVERING,
                                            getSettings()->pauseChatOnHover));

            form->addRow(
                "Mouse scroll speed:", this->createMouseScrollSlider());
            form->addRow("Links:",
...

        {
            ...
            groupLayout->addRow(LIMIT_CHATTERS_FOR_SMALLER_STREAMERS,
                this->createCheckBox(
            ...
            groupLayout->addRow(
                ...
                this->createSpinBox(
                    getSettings()->smallStreamerLimit, 10, 50000));
        }

        {
            ...
            groupLayout.append(this->createCheckBox(
                "Show whispers inline", getSettings()->inlineWhispers));
        }
