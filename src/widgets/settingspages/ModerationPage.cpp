...
namespace chatterino
{
        ...
        : SettingsPage("Moderation", ":/settings/moderation.svg")
    {
        ...
        auto logs = tabs.appendTab(new QVBoxLayout, "Logs");
        {
            ...
            QObject::connect(selectDir.getElement(), &QPushButton::clicked,
                this, [this, logsPathSizeLabel]() mutable {
        ...
        label->setStyleSheet("color: #bbb");
            ...
            /*auto taggedUsers = tabs.appendTab(new QVBoxLayout, "Tagged
            users");
            {
                EditableModelView *view =
            *taggedUsers.emplace<EditableModelView>(
