...
namespace chatterino
{
    ...
    {
        auto layout = LayoutCreator<KeyboardSettingsPage>(this)
                          .setLayoutType<QVBoxLayout>();

        auto form = layout.emplace<QFormLayout>();

        form->addRow(
            new QLabel("Hold Ctrl"), new QLabel("Show resize handles"));
        form->addRow(
            new QLabel("Hold Ctrl + Alt"), new QLabel("Show split overlay"));
        ...
        form->addRow(
            new QLabel("Ctrl + Shift + T"), new QLabel("Create new tab"));
        form->addRow(
            new QLabel("Ctrl + Shift + W"), new QLabel("Close current tab"));

        form->addItem(new QSpacerItem(16, 16));
        form->addRow(
            new QLabel("Ctrl + 1/2/3/..."), new QLabel("Select tab 1/2/3/..."));
        ...
        form->addRow(
            new QLabel("Ctrl + F"), new QLabel("Search in current channel"));
