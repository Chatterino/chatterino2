...
namespace chatterino
{
    LastRunCrashDialog::LastRunCrashDialog()
    {
        ...
        auto layout = LayoutCreator<LastRunCrashDialog>(this)
        ...
        //    QObject::connect(installUpdateButton, &QPushButton::clicked,
        //    [this, update]() mutable {
        ...
        QObject::connect(
            okButton, &QPushButton::clicked, [this] { this->accept(); });
        ...
        //                update->setText("Error while searching for
        ...
        //                update->setText(
        //                    "Downloading the update. Chatterino will close
        ...
        //                update->setText("Writing the update file to the hard
        //                drive failed.");
        //            } break;
        //        }
        //    };
        ...
        //        postToThread([updateUpdateLabel]() mutable {
        //        updateUpdateLabel();
        //        });
        //    });
    }
