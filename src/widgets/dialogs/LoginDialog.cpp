...
#endif
            messageBox.setWindowTitle("Chatterino - invalid account credentials");
...
BasicLoginWidget::BasicLoginWidget()
{
    ...
    this->ui_.unableToOpenBrowserHelper.setWindowTitle("Chatterino - unable to open in browser");
