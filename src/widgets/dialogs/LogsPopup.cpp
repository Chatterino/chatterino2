...
namespace chatterino
{
    ...
    void LogsPopup::getLogs()
    {
        if (this->channel_ && !this->channel_->isEmpty())
        {
                    ...
                    dynamic_cast<TwitchChannel*>(this->channel_.get()))
            {
                ...
                this->setWindowTitle(
                    this->userName_ + "'s logs in #" + this->channelName_);
                return;
            }
        }
        ...
        req.onSuccess([this, roomID](auto result) -> Outcome {
            ...
            for (auto i : before.toArray())
            {
                ...
                TwitchMessageBuilder builder(
                    this->channel_.get(), privMsg, args);
    ...
    {
        QString url = QString(
            "https://overrustlelogs.net/api/v1/stalk/%1/%2.json?limit=500")
                          .arg(this->channelName_, this->userName_);
        ...
        req.onError([this](int errorCode) {
            auto box =
                new QMessageBox(QMessageBox::Information, "Error getting logs",
            ...
            if (data.contains("lines"))
            {
                ...
                for (auto i : dataMessages)
                {
                    ...
                    builder.emplace<TextElement>(this->userName_,
                        MessageElementFlag::Username, MessageColor::System);
