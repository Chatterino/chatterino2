...
{
    class Scrollbar : public ab::BaseWidget
    {
        Q_OBJECT
    ...
    public:
        ...
        Q_PROPERTY(
            qreal desiredValue_ READ getDesiredValue WRITE setDesiredValue)

    signals:
        void currentValueChanged(qreal value);
        void desiredValueChanged(qreal value);
    ...
    private:
        Q_PROPERTY(
            qreal currentValue_ READ getCurrentValue WRITE setCurrentValue)
