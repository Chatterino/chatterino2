...
inline QStringList sampleCheerMessages{
...
inline QStringList sampleSubMessages{
...
inline QStringList sampleMiscMessages{
...
inline QStringList sampleEmoteTestMessages{
...
inline QString sampleChannelRewardMessage{
...
inline QString sampleChannelRewardMessage2{
...
inline QString sampleChannelRewardIRCMessage{
...
inline QStringList sampleValidLinks{
    R"(http://github.com/)",
    R"(https://github.com/)",
...
inline QStringList sampleValidButIgnoredLinks{
...
inline QStringList sampleInvalidLinks{
    R"(1.40)",
    R"(test..)",
    R"(test.)",
    R"(http://)",
...
inline QStringList sampleLinkMessages{
    // various link tests
    ...
    R"(@badge-info=subscriber/48;badges=broadcaster/1,subscriber/36,partner/1;color=#CC44FF;display-name=pajlada;emotes=;flags=;id=3c23cf3c-0864-4699-a76b-089350141147;mod=0;room-id=11148817;subscriber=1;tmi-sent-ts=1577628844607;turbo=0;user-id=11148817;user-type= :pajlada!pajlada@pajlada.tmi.twitch.tv PRIVMSG #pajlada : Links that should technically pass but we choose not to parse them: )" +
        sampleValidButIgnoredLinks.join(' '),
};
