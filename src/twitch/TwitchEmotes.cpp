...
namespace chatterino
{
    ...
    EmotePtr TwitchEmotes::getOrCreateEmote(
        const EmoteId& id, const EmoteName& name_)
    {
    ...
    AccessGuard<std::unordered_map<EmoteName, EmotePtr>>
        TwitchEmotes::accessAll()
    {
