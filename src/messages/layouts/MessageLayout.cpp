...
namespace chatterino
{
        ...
        bool isWindowFocused)
    {
...
#ifdef Q_OS_MACOS
            pixmap =
                new QPixmap(int(width * painter.device()->devicePixelRatioF()),
        ...
        {
            this->container_->paintSelection(
                painter, messageIndex, selection, y);
        }
        ...
        if (isLastReadMessage)
        {
            ...
            QBrush brush(
                color, static_cast<Qt::BrushStyle>(
    ...
    {
        // go through all words and return the first one that contains the
        // point.
    ...
    void MessageLayout::addSelectionText(
