...
Resources2::Resources2()
{
    ...
    this->buttons.emote2 = QPixmap(":/buttons/emote2.png");
    this->buttons.emote3 = QPixmap(":/buttons/emote3.png");
    ...
    this->buttons.settings = QPixmap(":/buttons/settings.png");
    ...
    this->buttons.user = QPixmap(":/buttons/user.png");
