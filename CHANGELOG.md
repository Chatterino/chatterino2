...
- Minor: Added `flags.shared` filter variable, allowing you to filter shared chat messages. (#5606)
- Minor: Hide subscriptions to other channels within a Shared Chat session to avoid confusion. (#5606)
