...
- Minor: Added "/popout" command - opens current split's web chat if no arguments are provided, if arguments are provided it will open provided channel. Usage: /popout <channel> (#2556)
