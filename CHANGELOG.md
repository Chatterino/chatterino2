...
- Major: Twitch follower emotes can now be corretly tabbed in other channels when you are subscribed. (#4922)
...
- Minor: Add `--activate <channel>` (or `-a`) command line option to focus or add a certain Twitch channel on startup. (#5111)
...
- Minor: Updated to Emoji v15.1. Google emojis are now used as the default instead of Twitter emojis. (#5182)
