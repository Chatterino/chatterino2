...
- Major: Newly uploaded Twitch emotes are once again present in the emote picker, and can be autocompleted with Tab. (#2992)
...
- Major: Added an username autocompletion popup menu when typing usernames with an @ prefix. (#1979, #2866)
...
- Minor: Channel names in the  `<channel> has gone offline. Exiting host mode.` messages are now clickable. (#2922)
...
- Minor: Sender username in automod messages shown to moderators now shows the correct color and display name. (#2967)
...
- Minor: Added setting for username style (#2889, #2891)
...
- Bugfix: Fixed bad behavior of the HTML color picker edit when user input is being entered. (#2942)
