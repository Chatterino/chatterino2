...
You can also add "-O2" to optimize the final binary but increase compilation time , add "-march=native" to break compatability with other achritechtures but optimize it further and add "-pipe" to use more ram in compilation but increase compilation speed
