...
-- Begin src/controllers/plugins/api/JSONParse.hpp

--- Parse a string as JSON
---
---@param input string The text to parse
---@param opts? {allow_comments?: boolean, allow_trailing_commas?: boolean} Additional options for parsing. `allow_comments` will allow C++ style comments ('// text').
---@return any
function c2.json_parse(input, opts) end

-- End src/controllers/plugins/api/JSONParse.hpp

-- Begin src/controllers/plugins/api/JSONStringify.hpp
...
---@return string
function c2.json_stringify(input, opts) end
...
---@type lightuserdata
c2.json_null = {}
-- End src/controllers/plugins/api/JSONStringify.hpp
